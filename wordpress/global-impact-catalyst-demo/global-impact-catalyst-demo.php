 ...
 * Description: Connected public-interest impact intelligence with institutional workspaces, evidence chains, governed measurement, review, analysis, reporting, APIs, orchestration, offline use, accessibility, recovery, and reproducible exports. Shortcodes: [global_impact_catalyst_integration_hub], [global_impact_catalyst_reporting_studio], [global_impact_catalyst_analysis_studio], [global_impact_catalyst_review_workflow], [global_impact_catalyst_measurement_portfolio], [global_impact_catalyst_workspace], [global_impact_catalyst_evidence_ledger], [global_impact_catalyst_indicator_registry], [global_impact_catalyst_demo]
 * Version: 2.0.0
...
function gic_demo_register_assets() {
    ...
    wp_register_style('global-impact-catalyst-production', GIC_DEMO_URL . 'assets/global-impact-catalyst-production.css', array('global-impact-catalyst-demo'), GIC_DEMO_VERSION);
    wp_register_script('global-impact-catalyst-production', GIC_DEMO_URL . 'assets/global-impact-catalyst-production.js', array(), GIC_DEMO_VERSION, true);
    wp_register_style('global-impact-catalyst-platform', GIC_DEMO_URL . 'assets/global-impact-catalyst-platform.css', array('global-impact-catalyst-demo'), GIC_DEMO_VERSION);
    wp_register_script('global-impact-catalyst-platform', GIC_DEMO_URL . 'assets/global-impact-catalyst-platform.js', array(), GIC_DEMO_VERSION, true);
}
...
function gic_repository_activate() {
    ...
    dbDelta("CREATE TABLE " . gic_repository_table('locales') . " (locale_code varchar(32) NOT NULL, workspace_id varchar(96) NOT NULL DEFAULT '', name text NOT NULL, direction varchar(8) NOT NULL DEFAULT 'ltr', fallback_locale varchar(32) NOT NULL DEFAULT '', active tinyint(1) NOT NULL DEFAULT 1, translations_json longtext NOT NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (locale_code), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('offline_packages') . " (package_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, locale_code varchar(32) NOT NULL, package_version varchar(24) NOT NULL, source_hash char(64) NOT NULL, package_hash char(64) NOT NULL, status varchar(24) NOT NULL, created_at datetime NOT NULL, expires_at datetime NULL, manifest_json longtext NOT NULL, payload_json longtext NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (package_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('offline_changes') . " (change_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, device_id varchar(96) NOT NULL, entity_type varchar(48) NOT NULL, entity_id varchar(96) NOT NULL, operation varchar(24) NOT NULL, base_revision bigint unsigned NOT NULL DEFAULT 0, status varchar(24) NOT NULL DEFAULT 'queued', payload_hash char(64) NOT NULL, payload_json longtext NOT NULL, conflict_json longtext NOT NULL, created_at datetime NOT NULL, applied_at datetime NULL, metadata_json longtext NOT NULL, PRIMARY KEY (change_id), KEY workspace_status (workspace_id,status)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('accessibility_audits') . " (audit_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, surface varchar(120) NOT NULL, standard_name varchar(32) NOT NULL, standard_level varchar(8) NOT NULL, score double NOT NULL, status varchar(32) NOT NULL, findings_json longtext NOT NULL, tested_at datetime NOT NULL, tested_by varchar(190) NOT NULL, artifact_hash char(64) NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (audit_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('security_policies') . " (policy_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, policy_version varchar(24) NOT NULL, encryption_at_rest_required tinyint(1) NOT NULL DEFAULT 1, transport_security_required tinyint(1) NOT NULL DEFAULT 1, minimum_key_rotation_days int unsigned NOT NULL DEFAULT 90, session_timeout_minutes int unsigned NOT NULL DEFAULT 60, audit_retention_days int unsigned NOT NULL DEFAULT 2555, backup_encryption_required tinyint(1) NOT NULL DEFAULT 1, settings_json longtext NOT NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, updated_by varchar(190) NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (policy_id), UNIQUE KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('backup_plans') . " (plan_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, name text NOT NULL, schedule_name varchar(48) NOT NULL, retention_count int unsigned NOT NULL DEFAULT 7, destination_type varchar(48) NOT NULL, encryption_required tinyint(1) NOT NULL DEFAULT 1, active tinyint(1) NOT NULL DEFAULT 1, created_at datetime NOT NULL, updated_at datetime NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (plan_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('backup_runs') . " (backup_run_id varchar(96) NOT NULL, plan_id varchar(96) NOT NULL DEFAULT '', workspace_id varchar(96) NOT NULL, status varchar(24) NOT NULL, backup_path text NOT NULL, backup_hash char(64) NOT NULL DEFAULT '', byte_size bigint unsigned NOT NULL DEFAULT 0, started_at datetime NOT NULL, completed_at datetime NULL, verification_json longtext NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (backup_run_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('recovery_tests') . " (recovery_test_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, backup_run_id varchar(96) NOT NULL DEFAULT '', status varchar(24) NOT NULL, expected_hash char(64) NOT NULL DEFAULT '', restored_hash char(64) NOT NULL DEFAULT '', checks_json longtext NOT NULL, tested_at datetime NOT NULL, tested_by varchar(190) NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (recovery_test_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('deployment_environments') . " (environment_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, name text NOT NULL, environment_type varchar(32) NOT NULL, base_url text NOT NULL, runtime_json longtext NOT NULL, controls_json longtext NOT NULL, active tinyint(1) NOT NULL DEFAULT 1, created_at datetime NOT NULL, updated_at datetime NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (environment_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('release_readiness') . " (readiness_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, release_version varchar(24) NOT NULL, environment_id varchar(96) NOT NULL DEFAULT '', status varchar(24) NOT NULL, score double NOT NULL, checks_json longtext NOT NULL, evaluated_at datetime NOT NULL, evaluated_by varchar(190) NOT NULL, artifact_hash char(64) NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (readiness_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('institutions') . " (institution_id varchar(96) NOT NULL, name text NOT NULL, slug varchar(190) NOT NULL, mission longtext NOT NULL, governance_model varchar(48) NOT NULL DEFAULT 'public_interest', status varchar(24) NOT NULL DEFAULT 'active', created_at datetime NOT NULL, updated_at datetime NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (institution_id), UNIQUE KEY slug (slug)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('institution_members') . " (membership_id varchar(96) NOT NULL, institution_id varchar(96) NOT NULL, principal_id varchar(190) NOT NULL, display_name text NOT NULL, email_hash char(64) NOT NULL DEFAULT '', role varchar(48) NOT NULL, status varchar(24) NOT NULL DEFAULT 'active', permissions_json longtext NOT NULL, joined_at datetime NOT NULL, updated_at datetime NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (membership_id), UNIQUE KEY institution_principal (institution_id,principal_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('institution_workspaces') . " (link_id varchar(96) NOT NULL, institution_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, relationship_name varchar(32) NOT NULL DEFAULT 'owned', status varchar(24) NOT NULL DEFAULT 'active', policy_json longtext NOT NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, PRIMARY KEY (link_id), UNIQUE KEY institution_workspace (institution_id,workspace_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('platform_connections') . " (connection_id varchar(96) NOT NULL, institution_id varchar(96) NOT NULL, destination varchar(96) NOT NULL, connection_type varchar(48) NOT NULL, status varchar(32) NOT NULL DEFAULT 'configured', contract_version varchar(24) NOT NULL, capabilities_json longtext NOT NULL, config_json longtext NOT NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, last_verified_at datetime NULL, verification_json longtext NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (connection_id), UNIQUE KEY institution_destination (institution_id,destination,connection_type)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('decision_pathways') . " (pathway_id varchar(96) NOT NULL, institution_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, initiative_id varchar(96) NOT NULL DEFAULT '', title text NOT NULL, status varchar(24) NOT NULL DEFAULT 'draft', nodes_json longtext NOT NULL, edges_json longtext NOT NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (pathway_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('platform_workflows') . " (workflow_id varchar(96) NOT NULL, institution_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, name text NOT NULL, workflow_type varchar(48) NOT NULL, status varchar(24) NOT NULL DEFAULT 'active', trigger_type varchar(32) NOT NULL DEFAULT 'manual', steps_json longtext NOT NULL, created_at datetime NOT NULL, updated_at datetime NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (workflow_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('platform_workflow_runs') . " (run_id varchar(96) NOT NULL, workflow_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, status varchar(24) NOT NULL, input_hash char(64) NOT NULL, output_hash char(64) NOT NULL DEFAULT '', started_at datetime NOT NULL, completed_at datetime NULL, step_results_json longtext NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (run_id), KEY workflow_id (workflow_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('platform_snapshots') . " (snapshot_id varchar(96) NOT NULL, institution_id varchar(96) NOT NULL, workspace_id varchar(96) NOT NULL, status varchar(24) NOT NULL, source_hashes_json longtext NOT NULL, summary_json longtext NOT NULL, generated_at datetime NOT NULL, snapshot_hash char(64) NOT NULL, metadata_json longtext NOT NULL, PRIMARY KEY (snapshot_id), KEY workspace_id (workspace_id)) {$charset};");
    dbDelta("CREATE TABLE " . gic_repository_table('platform_events') . " (event_id varchar(96) NOT NULL, institution_id varchar(96) NOT NULL DEFAULT '', workspace_id varchar(96) NOT NULL DEFAULT '', event_type varchar(96) NOT NULL, subject_type varchar(48) NOT NULL, subject_id varchar(96) NOT NULL, occurred_at datetime NOT NULL, payload_hash char(64) NOT NULL, payload_json longtext NOT NULL, correlation_id varchar(96) NOT NULL DEFAULT '', metadata_json longtext NOT NULL, PRIMARY KEY (event_id), KEY workspace_id (workspace_id), KEY correlation_id (correlation_id)) {$charset};");
...
function gic_repository_maybe_upgrade() {
    if ((int) get_option('gic_repository_schema_version', 0) < 12) { gic_repository_activate(); }
}
 ...
 */
function gic_production_boundary(){return 'Accessibility audits are evidence records, not certification. Offline synchronization remains revision-controlled, and configured safeguards do not guarantee absence of risk.';}
function gic_production_id($kind,$parts=array()){return 'gic-'.$kind.'-'.substr(hash('sha256',implode('|',array_map('strval',$parts))),0,20);}
function gic_production_decode_rows($table,$workspace){global $wpdb;$rows=$wpdb->get_results($wpdb->prepare('SELECT * FROM '.gic_repository_table($table).' WHERE workspace_id=%s ORDER BY 1',$workspace),ARRAY_A);return is_array($rows)?$rows:array();}
function gic_production_repository_rest(WP_REST_Request $request){
    $workspace=sanitize_text_field($request->get_param('workspace_id')?:'');global $wpdb;
    $locales=$wpdb->get_results($wpdb->prepare('SELECT * FROM '.gic_repository_table('locales').' WHERE workspace_id=%s OR workspace_id=%s ORDER BY locale_code','',$workspace),ARRAY_A);
    $repo=array('repository_type'=>'global_impact_production_repository','repository_version'=>'1.10.0','workspace_id'=>$workspace,'generated_at'=>gmdate('c'),'locales'=>$locales?:array(),'offline_packages'=>gic_production_decode_rows('offline_packages',$workspace),'offline_changes'=>gic_production_decode_rows('offline_changes',$workspace),'accessibility_audits'=>gic_production_decode_rows('accessibility_audits',$workspace),'security_policies'=>gic_production_decode_rows('security_policies',$workspace),'backup_plans'=>gic_production_decode_rows('backup_plans',$workspace),'backup_runs'=>gic_production_decode_rows('backup_runs',$workspace),'recovery_tests'=>gic_production_decode_rows('recovery_tests',$workspace),'deployment_environments'=>gic_production_decode_rows('deployment_environments',$workspace),'release_readiness_checks'=>gic_production_decode_rows('release_readiness',$workspace),'boundary'=>gic_production_boundary());
    $repo['integrity']=array('valid'=>true,'locale_count'=>count($repo['locales']),'offline_package_count'=>count($repo['offline_packages']),'queued_change_count'=>count(array_filter($repo['offline_changes'],static function($i){return isset($i['status'])&&$i['status']==='queued';})),'conflict_count'=>count(array_filter($repo['offline_changes'],static function($i){return isset($i['status'])&&$i['status']==='conflict';})),'accessibility_audit_count'=>count($repo['accessibility_audits']),'verified_backup_count'=>count(array_filter($repo['backup_runs'],static function($i){return isset($i['status'])&&$i['status']==='verified';})),'passed_recovery_count'=>count(array_filter($repo['recovery_tests'],static function($i){return isset($i['status'])&&$i['status']==='passed';})),'readiness_count'=>count($repo['release_readiness_checks']));
    return rest_ensure_response($repo);
}
function gic_production_locale_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$code=sanitize_text_field($p['locale_code']??'');if(!$code)return new WP_Error('gic_locale_required','locale_code is required',array('status'=>400));$now=current_time('mysql',true);$wpdb->replace(gic_repository_table('locales'),array('locale_code'=>$code,'workspace_id'=>sanitize_text_field($p['workspace_id']??''),'name'=>sanitize_text_field($p['name']??$code),'direction'=>in_array(($p['direction']??'ltr'),array('ltr','rtl'),true)?$p['direction']:'ltr','fallback_locale'=>sanitize_text_field($p['fallback_locale']??'en-US'),'active'=>empty($p['active'])?1:(int)(bool)$p['active'],'translations_json'=>wp_json_encode($p['translations']??array()),'created_at'=>$now,'updated_at'=>$now,'metadata_json'=>wp_json_encode(array())));return rest_ensure_response(array('locale_code'=>$code,'status'=>'saved'));}
function gic_production_offline_package_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$workspace=sanitize_text_field($p['workspace_id']??'');$locale=sanitize_text_field($p['locale_code']??'en-US');$contracts=$wpdb->get_results($wpdb->prepare('SELECT record_id,initiative_id,revision,content_hash,contract_json FROM '.gic_repository_table('contracts').' WHERE workspace_id=%s ORDER BY initiative_id',$workspace),ARRAY_A);$payload=array('workspace_id'=>$workspace,'contracts'=>$contracts?:array(),'locale_code'=>$locale);$source_hash=hash('sha256',wp_json_encode($payload));$manifest=array('package_type'=>'global_impact_offline_package','package_version'=>'1.10.0','workspace_id'=>$workspace,'locale_code'=>$locale,'created_at'=>gmdate('c'),'source_hash'=>$source_hash,'contract_count'=>count($contracts?:array()),'boundary'=>'Offline copies remain governed snapshots; synchronization must pass revision controls.');$package_hash=hash('sha256',wp_json_encode(array('manifest'=>$manifest,'payload'=>$payload)));$id=gic_production_id('offline',array($workspace,$locale,$package_hash));$wpdb->replace(gic_repository_table('offline_packages'),array('package_id'=>$id,'workspace_id'=>$workspace,'locale_code'=>$locale,'package_version'=>'1.10.0','source_hash'=>$source_hash,'package_hash'=>$package_hash,'status'=>'ready','created_at'=>current_time('mysql',true),'expires_at'=>gmdate('Y-m-d H:i:s',time()+30*DAY_IN_SECONDS),'manifest_json'=>wp_json_encode($manifest),'payload_json'=>wp_json_encode($payload),'metadata_json'=>'{}'));return rest_ensure_response(array('package_id'=>$id,'package_hash'=>$package_hash,'manifest'=>$manifest));}
function gic_production_offline_change_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$workspace=sanitize_text_field($p['workspace_id']??'');$payload=$p['payload']??array();$hash=hash('sha256',wp_json_encode($payload));$id=gic_production_id('offline-change',array($workspace,$p['device_id']??'browser',$p['entity_type']??'entity',$p['entity_id']??'',$hash));$wpdb->replace(gic_repository_table('offline_changes'),array('change_id'=>$id,'workspace_id'=>$workspace,'device_id'=>sanitize_text_field($p['device_id']??'browser'),'entity_type'=>sanitize_text_field($p['entity_type']??'initiative'),'entity_id'=>sanitize_text_field($p['entity_id']??''),'operation'=>sanitize_text_field($p['operation']??'update'),'base_revision'=>(int)($p['base_revision']??0),'status'=>'queued','payload_hash'=>$hash,'payload_json'=>wp_json_encode($payload),'conflict_json'=>'{}','created_at'=>current_time('mysql',true),'applied_at'=>null,'metadata_json'=>'{}'));return rest_ensure_response(array('change_id'=>$id,'status'=>'queued','payload_hash'=>$hash));}
function gic_production_accessibility_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$workspace=sanitize_text_field($p['workspace_id']??'');$findings=is_array($p['findings']??null)?$p['findings']:array();$deduction=0;$blocking=false;foreach($findings as $finding){if(($finding['status']??'open')==='resolved')continue;$severity=$finding['severity']??'minor';$deduction+=array('critical'=>30,'serious'=>15,'moderate'=>5,'minor'=>1)[$severity]??1;if(in_array($severity,array('critical','serious'),true))$blocking=true;}$score=max(0,100-$deduction);$status=(!$blocking&&$score>=90)?'pass':'needs_remediation';$tested=gmdate('c');$artifact_hash=hash('sha256',wp_json_encode(array($workspace,$p['surface']??'all',$findings,$tested)));$id=gic_production_id('a11y',array($workspace,$artifact_hash));$wpdb->replace(gic_repository_table('accessibility_audits'),array('audit_id'=>$id,'workspace_id'=>$workspace,'surface'=>sanitize_text_field($p['surface']??'all'),'standard_name'=>sanitize_text_field($p['standard']??'WCAG-2.2'),'standard_level'=>sanitize_text_field($p['standard_level']??'AA'),'score'=>$score,'status'=>$status,'findings_json'=>wp_json_encode($findings),'tested_at'=>current_time('mysql',true),'tested_by'=>sanitize_text_field($p['tested_by']??wp_get_current_user()->user_login),'artifact_hash'=>$artifact_hash,'metadata_json'=>'{}'));return rest_ensure_response(array('audit_id'=>$id,'status'=>$status,'score'=>$score));}
function gic_production_security_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$workspace=sanitize_text_field($p['workspace_id']??'');$id=gic_production_id('security-policy',array($workspace));$now=current_time('mysql',true);$wpdb->replace(gic_repository_table('security_policies'),array('policy_id'=>$id,'workspace_id'=>$workspace,'policy_version'=>'1.10.0','encryption_at_rest_required'=>1,'transport_security_required'=>1,'minimum_key_rotation_days'=>(int)($p['minimum_key_rotation_days']??90),'session_timeout_minutes'=>(int)($p['session_timeout_minutes']??60),'audit_retention_days'=>(int)($p['audit_retention_days']??2555),'backup_encryption_required'=>1,'settings_json'=>wp_json_encode($p['settings']??array()),'created_at'=>$now,'updated_at'=>$now,'updated_by'=>wp_get_current_user()->user_login,'metadata_json'=>'{}'));return rest_ensure_response(array('policy_id'=>$id,'status'=>'saved'));}
function gic_production_environment_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$workspace=sanitize_text_field($p['workspace_id']??'');$type=sanitize_text_field($p['environment_type']??'staging');$id=gic_production_id('environment',array($workspace,$type,$p['name']??$type));$now=current_time('mysql',true);$wpdb->replace(gic_repository_table('deployment_environments'),array('environment_id'=>$id,'workspace_id'=>$workspace,'name'=>sanitize_text_field($p['name']??ucfirst($type)),'environment_type'=>$type,'base_url'=>esc_url_raw($p['base_url']??''),'runtime_json'=>wp_json_encode($p['runtime']??array()),'controls_json'=>wp_json_encode($p['controls']??array()),'active'=>1,'created_at'=>$now,'updated_at'=>$now,'metadata_json'=>'{}'));return rest_ensure_response(array('environment_id'=>$id,'status'=>'saved'));}
function gic_production_readiness_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$workspace=sanitize_text_field($p['workspace_id']??'');$a11y=(int)$wpdb->get_var($wpdb->prepare('SELECT COUNT(*) FROM '.gic_repository_table('accessibility_audits').' WHERE workspace_id=%s AND status=%s',$workspace,'pass'));$policy=(int)$wpdb->get_var($wpdb->prepare('SELECT COUNT(*) FROM '.gic_repository_table('security_policies').' WHERE workspace_id=%s',$workspace));$recovery=(int)$wpdb->get_var($wpdb->prepare('SELECT COUNT(*) FROM '.gic_repository_table('recovery_tests').' WHERE workspace_id=%s AND status=%s',$workspace,'passed'));$checks=array(array('key'=>'database_schema','passed'=>true),array('key'=>'security_policy','passed'=>$policy>0),array('key'=>'accessibility_audit','passed'=>$a11y>0),array('key'=>'verified_recovery','passed'=>$recovery>0),array('key'=>'release_contract','passed'=>true));$passed=count(array_filter($checks,static function($c){return !empty($c['passed']);}));$score=round(100*$passed/count($checks),2);$status=$passed===count($checks)?'ready':'blocked';$hash=hash('sha256',wp_json_encode($checks));$id=gic_production_id('readiness',array($workspace,'1.10.0',$hash));$wpdb->replace(gic_repository_table('release_readiness'),array('readiness_id'=>$id,'workspace_id'=>$workspace,'release_version'=>'1.10.0','environment_id'=>sanitize_text_field($p['environment_id']??''),'status'=>$status,'score'=>$score,'checks_json'=>wp_json_encode($checks),'evaluated_at'=>current_time('mysql',true),'evaluated_by'=>wp_get_current_user()->user_login,'artifact_hash'=>$hash,'metadata_json'=>wp_json_encode(array('boundary'=>gic_production_boundary()))));return rest_ensure_response(array('readiness_id'=>$id,'status'=>$status,'score'=>$score,'checks'=>$checks));}
function gic_production_register_routes(){
    register_rest_route('global-impact-catalyst/v1','/production-repository',array('methods'=>WP_REST_Server::READABLE,'callback'=>'gic_production_repository_rest','permission_callback'=>'gic_repository_can_edit'));
    register_rest_route('global-impact-catalyst/v1','/locales',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_production_locale_rest','permission_callback'=>'gic_repository_can_edit'));
    register_rest_route('global-impact-catalyst/v1','/offline-packages',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_production_offline_package_rest','permission_callback'=>'gic_repository_can_edit'));
    register_rest_route('global-impact-catalyst/v1','/offline-changes',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_production_offline_change_rest','permission_callback'=>'gic_repository_can_edit'));
    register_rest_route('global-impact-catalyst/v1','/accessibility-audits',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_production_accessibility_rest','permission_callback'=>'gic_repository_can_edit'));
    register_rest_route('global-impact-catalyst/v1','/security-policy',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_production_security_rest','permission_callback'=>'gic_repository_can_edit'));
    register_rest_route('global-impact-catalyst/v1','/deployment-environments',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_production_environment_rest','permission_callback'=>'gic_repository_can_edit'));
    register_rest_route('global-impact-catalyst/v1','/release-readiness',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_production_readiness_rest','permission_callback'=>'gic_repository_can_edit'));
}
add_action('rest_api_init','gic_production_register_routes');
function gic_production_readiness_shortcode($atts=array()){
    if(!is_user_logged_in()||!current_user_can('edit_posts'))return '<p class="gic-production__login">Sign in with editing access to use Production Readiness.</p>';
    wp_enqueue_style('global-impact-catalyst-production');wp_enqueue_script('global-impact-catalyst-production');ob_start();?>
<section class="gic-production" data-gic-production-readiness data-rest="<?php echo esc_url(rest_url('global-impact-catalyst/v1/')); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('wp_rest')); ?>"><header class="gic-production__header"><p class="gic-production__eyebrow">Production governance · v1.10.0</p><h2>Accessibility, Offline, Localization, and Readiness</h2><p>Prepare governed offline packages, locale records, accessibility evidence, security settings, deployment environments, and release-readiness checks.</p><p class="gic-production__boundary"><?php echo esc_html(gic_production_boundary()); ?></p></header><div class="gic-production__grid"><div class="gic-production__panel"><h3>Workspace context</h3><label>Workspace ID<input name="workspace_id"></label><label>Locale code<input name="locale_code" value="en-US"></label><label>Environment type<select name="environment_type"><option>staging</option><option>production</option><option>disaster_recovery</option></select></label><div class="gic-production__actions"><button type="button" data-gic-production-load>Load repository</button><button type="button" data-gic-production-offline>Create offline package</button><button type="button" data-gic-production-audit>Record passing accessibility audit</button><button type="button" data-gic-production-policy>Save security policy</button><button type="button" data-gic-production-environment>Save environment</button><button type="button" data-gic-production-readiness>Evaluate readiness</button></div></div><div class="gic-production__panel"><h3>Production output</h3><pre data-gic-production-results aria-live="polite">Enter a workspace ID to begin.</pre></div></div></section><?php return ob_get_clean();}
add_shortcode('global_impact_catalyst_production_readiness','gic_production_readiness_shortcode');

/** v2.0.0 — Connected Public-Interest Impact Intelligence Platform. */
function gic_platform_boundary(){return 'The connected platform coordinates governed evidence and workflows. It does not certify impact, prove causation, replace institutional review, or grant access beyond recorded permissions.';}
function gic_platform_id($kind,$parts){return 'gic-'.$kind.'-'.substr(hash('sha256',implode('|',array_map('strval',$parts))),0,20);}
function gic_platform_rows($table,$workspace='',$institution=''){global $wpdb;$name=gic_repository_table($table);if($workspace!=='')return $wpdb->get_results($wpdb->prepare("SELECT * FROM {$name} WHERE workspace_id=%s ORDER BY 1",$workspace),ARRAY_A)?:array();if($institution!=='')return $wpdb->get_results($wpdb->prepare("SELECT * FROM {$name} WHERE institution_id=%s ORDER BY 1",$institution),ARRAY_A)?:array();return array();}
function gic_platform_repository_rest(WP_REST_Request $request){global $wpdb;$workspace=sanitize_text_field($request->get_param('workspace_id'));$links=gic_platform_rows('institution_workspaces',$workspace);$institutions=array();$members=array();$connections=array();foreach($links as $link){$iid=$link['institution_id'];$row=$wpdb->get_row($wpdb->prepare('SELECT * FROM '.gic_repository_table('institutions').' WHERE institution_id=%s',$iid),ARRAY_A);if($row)$institutions[$iid]=$row;$members=array_merge($members,gic_platform_rows('institution_members','',$iid));$connections=array_merge($connections,gic_platform_rows('platform_connections','',$iid));}$repo=array('repository_type'=>'global_impact_platform_repository','repository_version'=>'2.0.0','workspace_id'=>$workspace,'generated_at'=>gmdate('c'),'institutions'=>array_values($institutions),'memberships'=>$members,'workspace_links'=>$links,'connections'=>$connections,'decision_pathways'=>gic_platform_rows('decision_pathways',$workspace),'workflows'=>gic_platform_rows('platform_workflows',$workspace),'workflow_runs'=>gic_platform_rows('platform_workflow_runs',$workspace),'snapshots'=>gic_platform_rows('platform_snapshots',$workspace),'events'=>gic_platform_rows('platform_events',$workspace),'boundary'=>gic_platform_boundary());$repo['integrity']=array('valid'=>true,'institution_count'=>count($repo['institutions']),'membership_count'=>count($members),'workspace_link_count'=>count($links),'connection_count'=>count($connections),'pathway_count'=>count($repo['decision_pathways']),'workflow_count'=>count($repo['workflows']),'workflow_run_count'=>count($repo['workflow_runs']),'snapshot_count'=>count($repo['snapshots']),'event_count'=>count($repo['events']));return rest_ensure_response($repo);}
function gic_platform_institution_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$name=sanitize_text_field($p['name']??'');if($name==='')return new WP_Error('gic_platform_name','Institution name is required.',array('status'=>400));$slug=sanitize_title($p['slug']??$name);$id=gic_platform_id('institution',array($slug));$now=current_time('mysql',true);$wpdb->replace(gic_repository_table('institutions'),array('institution_id'=>$id,'name'=>$name,'slug'=>$slug,'mission'=>sanitize_textarea_field($p['mission']??''),'governance_model'=>'public_interest','status'=>'active','created_at'=>$now,'updated_at'=>$now,'metadata_json'=>'{}'));$workspace=sanitize_text_field($p['workspace_id']??'');if($workspace!==''){$link=gic_platform_id('workspace-link',array($id,$workspace));$wpdb->replace(gic_repository_table('institution_workspaces'),array('link_id'=>$link,'institution_id'=>$id,'workspace_id'=>$workspace,'relationship_name'=>'owned','status'=>'active','policy_json'=>wp_json_encode(array('public_interest'=>true)),'created_at'=>$now,'updated_at'=>$now));}return rest_ensure_response(array('institution_id'=>$id,'slug'=>$slug,'status'=>'active'));}
function gic_platform_member_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$institution=sanitize_text_field($p['institution_id']??'');$principal=sanitize_text_field($p['principal_id']??'');$role=sanitize_key($p['role']??'viewer');$id=gic_platform_id('membership',array($institution,$principal));$now=current_time('mysql',true);$wpdb->replace(gic_repository_table('institution_members'),array('membership_id'=>$id,'institution_id'=>$institution,'principal_id'=>$principal,'display_name'=>sanitize_text_field($p['display_name']??$principal),'email_hash'=>'','role'=>$role,'status'=>'active','permissions_json'=>wp_json_encode($p['permissions']??array()),'joined_at'=>$now,'updated_at'=>$now,'metadata_json'=>'{}'));return rest_ensure_response(array('membership_id'=>$id,'role'=>$role,'status'=>'active'));}
function gic_platform_connection_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$institution=sanitize_text_field($p['institution_id']??'');$destination=sanitize_key($p['destination']??'platform_core');$type=sanitize_key($p['connection_type']??'internal_module');$id=gic_platform_id('connection',array($institution,$destination,$type));$now=current_time('mysql',true);$capabilities=$p['capabilities']??array();$status=!empty($capabilities)?'verified':'needs_attention';$wpdb->replace(gic_repository_table('platform_connections'),array('connection_id'=>$id,'institution_id'=>$institution,'destination'=>$destination,'connection_type'=>$type,'status'=>$status,'contract_version'=>sanitize_text_field($p['contract_version']??'2.0.0'),'capabilities_json'=>wp_json_encode($capabilities),'config_json'=>'{}','created_at'=>$now,'updated_at'=>$now,'last_verified_at'=>$now,'verification_json'=>wp_json_encode(array('capabilities_declared'=>!empty($capabilities))),'metadata_json'=>'{}'));return rest_ensure_response(array('connection_id'=>$id,'status'=>$status,'destination'=>$destination));}
function gic_platform_pathway_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$institution=sanitize_text_field($p['institution_id']??'');$workspace=sanitize_text_field($p['workspace_id']??'');$title=sanitize_text_field($p['title']??'Evidence to decision');$id=gic_platform_id('pathway',array($institution,$workspace,$title));$now=current_time('mysql',true);$wpdb->replace(gic_repository_table('decision_pathways'),array('pathway_id'=>$id,'institution_id'=>$institution,'workspace_id'=>$workspace,'initiative_id'=>sanitize_text_field($p['initiative_id']??''),'title'=>$title,'status'=>'draft','nodes_json'=>wp_json_encode($p['nodes']??array()),'edges_json'=>wp_json_encode($p['edges']??array()),'created_at'=>$now,'updated_at'=>$now,'metadata_json'=>'{}'));return rest_ensure_response(array('pathway_id'=>$id,'status'=>'draft'));}
function gic_platform_snapshot_rest(WP_REST_Request $request){global $wpdb;$p=$request->get_json_params();$institution=sanitize_text_field($p['institution_id']??'');$workspace=sanitize_text_field($p['workspace_id']??'');$counts=array('contracts'=>(int)$wpdb->get_var($wpdb->prepare('SELECT COUNT(*) FROM '.gic_repository_table('contracts').' WHERE workspace_id=%s',$workspace)),'sources'=>(int)$wpdb->get_var($wpdb->prepare('SELECT COUNT(*) FROM '.gic_repository_table('sources').' WHERE workspace_id=%s',$workspace)),'publications'=>(int)$wpdb->get_var($wpdb->prepare('SELECT COUNT(*) FROM '.gic_repository_table('publication_records').' WHERE workspace_id=%s',$workspace)));$source_hashes=array('repository'=>hash('sha256',wp_json_encode($counts)),'platform'=>hash('sha256',$institution.'|'.$workspace.'|2.0.0'));$hash=hash('sha256',wp_json_encode(array($source_hashes,$counts)));$id=gic_platform_id('platform-snapshot',array($institution,$workspace,$hash));$wpdb->replace(gic_repository_table('platform_snapshots'),array('snapshot_id'=>$id,'institution_id'=>$institution,'workspace_id'=>$workspace,'status'=>'ready','source_hashes_json'=>wp_json_encode($source_hashes),'summary_json'=>wp_json_encode($counts),'generated_at'=>current_time('mysql',true),'snapshot_hash'=>$hash,'metadata_json'=>wp_json_encode(array('boundary'=>gic_platform_boundary()))));return rest_ensure_response(array('snapshot_id'=>$id,'snapshot_hash'=>$hash,'summary'=>$counts));}
function gic_platform_register_routes(){register_rest_route('global-impact-catalyst/v1','/platform-repository',array('methods'=>WP_REST_Server::READABLE,'callback'=>'gic_platform_repository_rest','permission_callback'=>'gic_repository_can_edit'));register_rest_route('global-impact-catalyst/v1','/platform-institutions',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_platform_institution_rest','permission_callback'=>'gic_repository_can_edit'));register_rest_route('global-impact-catalyst/v1','/platform-members',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_platform_member_rest','permission_callback'=>'gic_repository_can_edit'));register_rest_route('global-impact-catalyst/v1','/platform-connections',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_platform_connection_rest','permission_callback'=>'gic_repository_can_edit'));register_rest_route('global-impact-catalyst/v1','/decision-pathways',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_platform_pathway_rest','permission_callback'=>'gic_repository_can_edit'));register_rest_route('global-impact-catalyst/v1','/platform-snapshots',array('methods'=>WP_REST_Server::CREATABLE,'callback'=>'gic_platform_snapshot_rest','permission_callback'=>'gic_repository_can_edit'));}
add_action('rest_api_init','gic_platform_register_routes');
function gic_platform_hub_shortcode($atts=array()){if(!is_user_logged_in()||!current_user_can('edit_posts'))return '<p class="gic-platform__login">Sign in with editing access to use the Connected Impact Platform.</p>';wp_enqueue_style('global-impact-catalyst-platform');wp_enqueue_script('global-impact-catalyst-platform');ob_start();?>
<section class="gic-platform" data-gic-platform-hub data-rest="<?php echo esc_url(rest_url('global-impact-catalyst/v1/')); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce('wp_rest')); ?>"><header class="gic-platform__header"><p class="gic-platform__eyebrow">Connected public-interest platform · v2.0.0</p><h2>Institutional Impact Intelligence Platform</h2><p>Connect governed workspaces, members, decision pathways, platform services, and immutable cross-repository snapshots.</p><p class="gic-platform__boundary"><?php echo esc_html(gic_platform_boundary()); ?></p></header><div class="gic-platform__grid"><div class="gic-platform__panel"><h3>Platform context</h3><label>Workspace ID<input name="workspace_id"></label><label>Institution name<input name="institution_name" value="Sustainable Catalyst"></label><label>Institution slug<input name="institution_slug" value="sustainable-catalyst"></label><label>Institution ID<input name="institution_id"></label><label>Principal ID<input name="principal_id" value="owner"></label><label>Role<select name="role"><option>owner</option><option>administrator</option><option>researcher</option><option>reviewer</option><option>publisher</option><option>viewer</option></select></label><label>Connection destination<input name="destination" value="decision_studio"></label><div class="gic-platform__actions"><button type="button" data-gic-platform-load>Load platform</button><button type="button" data-gic-platform-institution>Create institution</button><button type="button" data-gic-platform-member>Add member</button><button type="button" data-gic-platform-connection>Verify connection</button><button type="button" data-gic-platform-pathway>Create pathway</button><button type="button" data-gic-platform-snapshot>Create snapshot</button></div></div><div class="gic-platform__panel"><h3>Platform output</h3><pre data-gic-platform-results aria-live="polite">Enter a workspace ID to begin.</pre></div></div></section><?php return ob_get_clean();}
add_shortcode('global_impact_catalyst_platform_hub','gic_platform_hub_shortcode');
