...
define('GIC_DEMO_VERSION', '1.10.0');
...
function gic_repository_activate() {
    ...
    update_option('gic_repository_schema_version', 11, false);
}
register_activation_hook(__FILE__, 'gic_repository_activate');

function gic_repository_maybe_upgrade() {
    if ((int) get_option('gic_repository_schema_version', 0) < 11) { gic_repository_activate(); }
}
